...
const RecruiterFilterSidebar = ({
  ...
  return (
    <aside className="w-full rounded-2xl border border-[#EAEFF7] bg-white p-6 shadow-sm sticky top-28 max-h-[calc(100vh-130px)] overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-gray-200 [&::-webkit-scrollbar-thumb]:rounded-full">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-[#F0F4FC] pb-4 sticky top-0 bg-white z-10">
