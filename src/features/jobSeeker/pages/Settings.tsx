...
export const Settings: React.FC = () => {
  ...
  const candidateEmail = user?.email || "candidate@jobbox.com";
    ...
    <div className="h-full overflow-y-auto overscroll-contain pr-1 pb-12 space-y-6 max-w-4xl [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-gray-200 [&::-webkit-scrollbar-thumb]:rounded-full">
      ...
      <div>
        ...
        <p className="mt-1 text-xs sm:text-sm font-medium text-[#66789C]">
          Manage your candidate profile credentials, account parameters, and security settings
        </p>
      </div>
        ...
        <div className="flex items-center gap-3 border-b border-[#EAEFF7] pb-5 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-[#66789C]">
              Your registered job seeker account details
            </p>
          </div>
        </div>
      ...
      <div className="rounded-3xl border border-red-200 bg-red-50/50 p-6 sm:p-8 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs font-medium text-gray-600 mt-0.5">
            End your current candidate session.
          </p>
        </div>
